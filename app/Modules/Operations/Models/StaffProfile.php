...
{
    protected $fillable = ['core_user_id', 'branch_id', 'first_name', 'last_name', 'birth_date', 'phone', 'email', 'emergency_contact_name', 'emergency_contact_relationship', 'emergency_contact_phone', 'status'];
