        ...
        <div class="app-shell">
            ...
            <aside class="app-sidebar">
                <div class="sidebar-scroll" data-simplebar>
                    ...
                    @if ($canOperateTenant)<ul class="side-nav"><li class="side-nav-item"><span class="side-nav-link"><i data-lucide="calendar-days"></i><span>Horarios</span></span><ul class="side-nav-sub">@if ($canAdministerSchedule)<li><a class="side-nav-link {{ request()->routeIs('operations.planner') ? 'active' : '' }}" href="{{ route('operations.planner') }}"><span>Planificar</span></a></li><li><a class="side-nav-link {{ request()->routeIs('operations.schedule') ? 'active' : '' }}" href="{{ route('operations.schedule') }}"><span>Calendario</span></a></li><li><a class="side-nav-link {{ request()->routeIs('operations.shifts') ? 'active' : '' }}" href="{{ route('operations.shifts') }}"><span>Turnos</span></a></li>@if ($canManageTenant)<li><a class="side-nav-link {{ request()->routeIs('operations.schedule.settings*') ? 'active' : '' }}" href="{{ route('operations.schedule.settings') }}"><span>Configurar jornada</span></a></li>@endif<li><a class="side-nav-link {{ request()->routeIs('operations.schedule.report') ? 'active' : '' }}" href="{{ route('operations.schedule.report') }}"><span>Reporte de jornada</span></a></li>@endif<li><a class="side-nav-link {{ request()->routeIs('operations.my-tasks') ? 'active' : '' }}" href="{{ route('operations.my-tasks') }}"><span>Mis tareas</span></a></li></ul></li></ul>@endif
                    @if ($canOperateTenant)
                    ...
                    @if($canManageTenant)<p class="sidebar-heading">Productos</p><ul class="side-nav"><li class="side-nav-item"><a class="side-nav-link {{ request()->routeIs('products.index','products.show','products.create','products.edit') ? 'active' : '' }}" href="{{ route('products.index') }}"><i data-lucide="package"></i><span>Catálogo</span></a></li><li class="side-nav-item"><a class="side-nav-link {{ request()->routeIs('products.categories*') ? 'active' : '' }}" href="{{ route('products.categories') }}"><i data-lucide="tags"></i><span>Categorías</span></a></li>@if(\App\Modules\Products\Models\ProductSetting::first()?->manages_collections)<li class="side-nav-item"><a class="side-nav-link {{ request()->routeIs('products.collections*') ? 'active' : '' }}" href="{{ route('products.collections') }}"><i data-lucide="layers-3"></i><span>Colecciones</span></a></li>@endif<li class="side-nav-item"><a class="side-nav-link {{ request()->routeIs('products.types*') ? 'active' : '' }}" href="{{ route('products.types.index') }}"><i data-lucide="shapes"></i><span>Tipos</span></a></li><li class="side-nav-item"><a class="side-nav-link {{ request()->routeIs('products.settings*') ? 'active' : '' }}" href="{{ route('products.settings') }}"><i data-lucide="sliders-horizontal"></i><span>Configuración</span></a></li></ul>@endif
                </div>
            </aside>
