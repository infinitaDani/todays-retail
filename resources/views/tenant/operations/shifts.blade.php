<x-layouts.tenant
    title="Turnos"
    subtitle="Definiciones de jornadas operativas"
>
    <div class="row g-3 mb-4">
        @foreach ([
            ['Total', $summary['total'], 'clock-3', 'primary'],
            ['Activos', $summary['active'], 'check-circle-2', 'success'],
            ['Inactivos', $summary['inactive'], 'pause-circle', 'warning'],
            ['Con asignaciones', $summary['assigned'], 'calendar-days', 'primary'],
        ...
        >
            ...
            <div class="listing-filters">
                ...
                <a
                    ...
                    href="{{ route('operations.shifts.create') }}"
                >
                ...
                <tbody>
                    @forelse ($shifts as $shift)
                        <tr>
                            ...
                            <td>
                                <span
                                    class="badge badge-label badge-soft-{{ $shift->status === 'active'
                                        ? 'success'
                                        : 'warning' }}"
                                >
                                    {{ $shift->status === 'active'
                            ...
                            <td class="text-end">
                                <a
                                    ...
                                    href="{{ route('operations.shifts.show', $shift) }}"
                                    title="Ver"
                                >
                                    <i data-lucide="eye"></i>
                                </a>
